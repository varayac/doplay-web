...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\GameType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\GameType']) ? $this->services['AppBundle\\Form\\GameType'] : ($this->services['AppBundle\\Form\\GameType'] = new \AppBundle\Form\GameType())) && false ?: '_'};
